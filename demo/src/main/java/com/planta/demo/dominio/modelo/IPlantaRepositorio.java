...
public interface IPlantaRepositorio {
     ...
     * @param planta Planta con los cambios aplicados
     */
    ...
    /**
     * Obtiene un registro personal por su ID.
     * @param registroId ID del registro personal
     * @return Registro encontrado o null si no existe
     */
    RegistroPlanta obtenerRegistroPorId(int registroId);
    ...
    /**
     * @deprecated Usar listarRegistrosPorUsuario() en su lugar
     */
    @Deprecated
